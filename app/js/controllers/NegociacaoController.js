System.register(["../models/index", "../views/index", "../helpers/decorators/index", "../services/index"], function (exports_1, context_1) {
    ...
    var index_1, index_2, index_3, index_4, NegicaoController, DiaDaSemana;
    ...
    return {
        ...
        execute: function () {
            NegicaoController = class NegicaoController {
                ...
                importaDados() {
                    this._negociacaoService
                        ...
                        .then(negociacoes => {
                        negociacoes.forEach(negociacao => this._negociacoes.AddArray(negociacao));
                        this._negociacoesView.update(this._negociacoes);
                    });
                }
            };
            ...
            __decorate([
                index_3.throttle()
            ], NegicaoController.prototype, "importaDados", null);
